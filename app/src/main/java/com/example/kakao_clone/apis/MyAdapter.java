...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //iv_img.setBackground(new ShapeDrawable(new OvalShape()));
        GradientDrawable gradientDrawable= (GradientDrawable) context.getDrawable(R.drawable.rounded);
        iv_img.setBackground(gradientDrawable);
                iv_img.setClipToOutline(true);

        MyItem myItem = (MyItem) getItem(position);
        myItem.setMyView(convertView);
